...
- Set up an [Arduino as ISP](https://www.notesandvolts.com/2013/01/fun-with-arduino-arduino-as-isp.html) to copy the arduino script on the ATMEGA328P microcontroller to miniaturize the blinking LED circuit on a breadboard.
